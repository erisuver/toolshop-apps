...
public class KeranjangModel {
    ...
    private int qty;
    private String is_pilih;

    public KeranjangModel(int seq_barang, int seq_satuan, String nama_barang, String nama_satuan, String gambar, double harga_awal, double harga_akhir, double diskon_pct, int qty, String is_pilih) {
    ...
    public String getIs_pilih() {
        return is_pilih;
    }

    public void setIs_pilih(String is_pilih) {
        this.is_pilih = is_pilih;
    }
}
