...
final public class SharedPrefsUtils {
    ...
    public static double getDoublePreference(Context context, String key, double defaultValue) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
    ...
    public static boolean setDoublePreference(Context context, String key, double value) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
            SharedPreferences.Editor editor = preferences.edit();
     ...
     * @param key
     * @param value
     * @return true if the new value was successfully written to persistent storage.F
     */
    ...
    // Metode untuk menghapus semua preferensi
